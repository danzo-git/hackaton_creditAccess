        ...
        <div class="formbg-outer">
          <div class="formbg">
            <div class="formbg-inner padding-horizontal--48">
              ...
              <form id="stripe-login" action="{{route('valide.credit')}}" method="post">
                @csrf
                <div class="field padding-bottom--24">
                  <label for="email">Type Materiel</label>
                  <select name="type_materiel" class="form-control" placeholder="type materiel" id="" >
                ...
                <div class="field padding-bottom--24">
                    ...
                    <input type="hidden" name="id_clientq" value="{{$id}}">
                  </div>
                <div class="field padding-bottom--24">
                  ...
                  <div class="field padding-bottom--24">
                    <label for="email">loyer</label>
                    <input type="text" name="loyer">
                  </div>
                  <div class="field padding-bottom--24">
                    <label for="email">Nom fournisseur</label>
                    <input type="text" name="fnom">
                  </div>
                  <div class="field padding-bottom--24">
                    <label for="email">telephone fournisseur</label>
                    <input type="fphone" name="fphone">
                  </div>
                  <div class="field padding-bottom--24">
