...
<head>
	...
	<title>Facture {{$contrat->id}}</title>
					...
					<div class="invoice-wrapper">
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="invoice-top-left">
										<h2 class="client-company-name">CreditBail.</h2>
										<h6 class="client-address">Employeur:{{$clients->employeur}} <br>Delaware, AC 987869 <br></h6>
										<h4>Reference</h4>
										<h5>Kouame Akoun Kamarou & Demaurelle <br> Corporation.</h5>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="invoice-top-right">
										<h2 class="our-company-name">{{$clients->nom}}</h2>
										<h6 class="our-address">{{$clients->email}} <br>{{$clients->telephone}}<br></h6>
						...
						<div class="invoice-bottom">
							<div class="row">
										...
										<table class="table">
											<thead>
												<tr>
													<th>Quantite</th>
													<th>Designation</th>
													<th>Loyer a payer chaque mois</th>
												</tr>
											</thead>
											<tbody>
												<tr>
											...
											<thead>
												<tr>
													<th>Total</th>
													<th></th>
													<th>{{intval($contrat->loyer) *0.18+ intval($contrat->loyer)}}</th>
												</tr>
											</thead>
										</table>
								...
								<div class="col-sm-4">
									<h6 class="text-left">{{$clients->nom}}</h6>
								</div>
								<div class="col-sm-4">
									<h6 class="text-center">{{$contrat->fmail}}</h6>
								</div>
								<div class="col-sm-4">
									<h6 class="text-right">{{$contrat->fphone}}</h6>
								</div>
							</div>
